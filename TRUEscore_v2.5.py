...
@author: Soni Yatheendradas & Abhijit Naik
"""

# HARDCODED INFORMATION FOR REFERENCE:
# '''
#
# no of past months considered = 12
#
#Dict_DelinqStatusToOrdinalValue = {'X': 0, 'P': 1, 'L': 2, 'Q': 4, 'D': 8, 'W': 16}
#
# In function scaling_function:
#    Dict_PastMaxes is  {'trans_count_mean': 18993.916666666668,
...
#
# In function discretization_function:
...
#                                                        [12.0/16.0, 1.0]]}
#
# In function data_encoding as argument but not really used for now:
#    Dict_PastMins is  {'trans_count_mean': 0.0,
#                       'trans_count_std': 0.0,
#                       'trans_count_skews': -3.0275869297169313,
#                       'trans_count_kurtosis': -2.420340332148667,
#                       'trans_vol_mean': 0.0,
#                       'trans_vol_std': 0.0,
#                       'trans_vol_skews': -2.870570371848255,
#                       'trans_vol_kurtosis': -2.418592803496926,
#                       'ValuePerCount_mean': 0.0,
#                       'ValuePerCount_std': 0.0,
#                       'ValuePerCount_skews': -3.4218448131372665,
#                       'ValuePerCount_kurtosis': -2.44322076090271}
#
# '''
...
# lines = sys.stdin
# fl=open('test.json')
# # strFile=pd.DataFrame.to_json('test.json')
# # ?print(strFile)
# # aa = json.load(fl)
# df = pd.read_json(fl.read( ))
# # df = pd.DataFrame(fl.read())
